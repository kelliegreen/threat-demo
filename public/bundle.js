...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	_reactRouter2['default'].run(_configRoutes2['default'], function (Root, state) {
	  _react2['default'].render(_react2['default'].createElement(Root, state), document.body);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _componentsThreatsThreatsShow = __webpack_require__(210);

	var _componentsThreatsThreatsShow2 = _interopRequireDefault(_componentsThreatsThreatsShow);

	var _componentsThreatsThreatsList = __webpack_require__(203);

	var _componentsThreatsThreatsList2 = _interopRequireDefault(_componentsThreatsThreatsList);
	...
	exports['default'] = _react2['default'].createElement(
	  ...
	  _react2['default'].createElement(
	    ...
	    _react2['default'].createElement(_reactRouter.Route, { name: 'threats-show', path: ':id', handler: _componentsThreatsThreatsShow2['default'] }),
	    _react2['default'].createElement(_reactRouter.DefaultRoute, { name: 'threats-index', handler: _componentsThreatsThreatsList2['default'] })
	  ),
	  _react2['default'].createElement(_reactRouter.DefaultRoute, { name: 'app-index', handler: _componentsDashboard2['default'] })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _stylesMainScss = __webpack_require__(198);
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement('img', { className: 'logo', src: 'images/logo.png', alt: 'AB Demo' })
	            ),
	            _react2['default'].createElement(
	              _reactRouter.Link,
	              { to: 'app-index', className: 'item' },
	              'Welcome'
	            ),
	            _react2['default'].createElement(
	              _reactRouter.Link,
	              { to: 'threats-index', className: 'item' },
	              'Threat List'
	            )
	          )
	        ),
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            "p",
	            null,
	            "Welcome to my Simple Threat Manager Demo. This is a small application utilizing React, WebPack, and Firebase."
	          ),
	          _react2["default"].createElement(
	            "p",
	            null,
	            "For source and setup instructions please see the ",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reBase = __webpack_require__(204);

	var _reBase2 = _interopRequireDefault(_reBase);

	var _ThreatsListRow = __webpack_require__(207);

	var _ThreatsListRow2 = _interopRequireDefault(_ThreatsListRow);

	var base = _reBase2['default'].createClass('https://tmp-threat-db.firebaseio.com/');

	var ThreatsList = (function (_React$Component) {
	  _inherits(ThreatsList, _React$Component);

	  function ThreatsList(props) {
	    _classCallCheck(this, ThreatsList);

	    _get(Object.getPrototypeOf(ThreatsList.prototype), 'constructor', this).call(this, props);
	    this.state = {
	      threats: []
	    };
	  }

	  _createClass(ThreatsList, [{
	    key: 'init',
	    value: function init() {
	    ...
	    key: 'getThreatAtIndex',
	    value: function getThreatAtIndex(index) {
	      return this.state.threats[index];
	    }
	  }, {
	    key: 'handleNewThreat',
	    value: function handleNewThreat() {
	    ...
	    key: 'handleDeleteThreat',
	    value: function handleDeleteThreat(idx) {
	    ...
	    key: 'handleUpdateThreat',
	    value: function handleUpdateThreat(idx, newName) {
	      var threat = this.getThreatAtIndex(idx);
	      threat.name = newName;
	      base.post('threats/' + idx, {
	        data: threat
	    ...
	    value: function render() {
	      ...
	      var threats = this.state.threats.map(function (threat, index) {
	        if (!threat.isClosed) {
	          return _react2['default'].createElement(_ThreatsListRow2['default'], { threat: threat, idx: index, key: index,
	            onUpdate: _this.handleUpdateThreat.bind(_this), onDelete: _this.handleDeleteThreat.bind(_this) });
	        }
	      });
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  'form',
	                  { onSubmit: this.handleNewThreat.bind(this) },
	                  _react2['default'].createElement(
	                    'div',
	                    { className: 'ui action input float-right' },
	                    _react2['default'].createElement('input', { type: 'text', ref: 'newThreat', placeholder: 'Threat Name' }),
	                    _react2['default'].createElement(
	                      'button',
	                      { type: 'submit', className: 'ui orange right labeled icon button' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ThreatsListRow = (function (_React$Component) {
	  _inherits(ThreatsListRow, _React$Component);

	  function ThreatsListRow(props) {
	    _classCallCheck(this, ThreatsListRow);

	    _get(Object.getPrototypeOf(ThreatsListRow.prototype), 'constructor', this).call(this, props);
	    this.state = {
	      isEditing: false,
	  ...
	  _createClass(ThreatsListRow, [{
	    ...
	    key: 'handleThreatNameChange',
	    value: function handleThreatNameChange(evt) {
	      ...
	      if (!this.state.isEditing && !this.props.threat.isClosed) {
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              _reactRouter.Link,
	              { to: 'threats-show', params: { id: this.props.idx } },
	              this.props.threat.name
	            )
	          ),
	          _react2['default'].createElement(
	            'td',
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'div',
	              { className: 'small ui icon buttons' },
	              _react2['default'].createElement(
	                'button',
	                { className: 'ui button', onClick: this.handleToggleEditing.bind(this) },
	                _react2['default'].createElement('i', { className: 'edit icon' })
	              ),
	              _react2['default'].createElement(
	                'button',
	                { className: 'ui button', onClick: this.handleDelete.bind(this) },
	        ...
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'div',
	              { className: 'ui input' },
	              _react2['default'].createElement('input', { type: 'text', placeholder: 'Threat Name', value: this.state.editName,
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                'button',
	                { type: 'submit', className: 'ui button', onClick: this.handleUpdate.bind(this) },
	                _react2['default'].createElement('i', { className: 'checkmark icon' })
	              ),
	              _react2['default'].createElement(
	                'button',
	                { className: 'ui button', onClick: this.handleToggleEditing.bind(this) },
	                _react2['default'].createElement('i', { className: 'ban icon' })
	              )
	            )
	          )
	        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ThreatsShowNote = __webpack_require__(211);

	var _ThreatsShowNote2 = _interopRequireDefault(_ThreatsShowNote);

	var base = _reBase2['default'].createClass('https://tmp-threat-db.firebaseio.com/');

	var ThreatsShow = (function (_React$Component) {
	  _inherits(ThreatsShow, _React$Component);

	  function ThreatsShow(props) {
	    _classCallCheck(this, ThreatsShow);

	    _get(Object.getPrototypeOf(ThreatsShow.prototype), 'constructor', this).call(this, props);
	    this.state = {
	      threat: {}
	    };
	  }

	  _createClass(ThreatsShow, [{
	    key: 'init',
	    value: function init() {
	    ...
	    value: function handleDeleteNote(idx) {}
	  }, {
	    key: 'render',
	    value: function render() {
	      var _this = this;
	      ...
	      var notesToDisplay = notes.map(function (note, index) {
	        return _react2['default'].createElement(_ThreatsShowNote2['default'], { note: note, idx: index, key: index,
	          onDelete: _this.handleDeleteNote.bind(_this) });
	      });
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            _reactRouter.Link,
	            { to: 'threats-index', className: 'section' },
	            'Threat List'
	          ),
	          _react2['default'].createElement(
	            'div',
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  'div',
	                  { className: 'field' },
	                  _react2['default'].createElement('textarea', { ref: 'newNote' })
	                ),
	                _react2['default'].createElement(
	                  'div',
	                  { className: 'ui orange submit labeled icon button', onClick: this.handleAddNote.bind(this) },
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                  'p',
	                  null,
	                  this.state.threat.isClosed ? 'Yes' : 'No'
	                )
	              )
	            )
	          )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ThreatsShowNote = (function (_React$Component) {
	  _inherits(ThreatsShowNote, _React$Component);

	  function ThreatsShowNote() {
	    _classCallCheck(this, ThreatsShowNote);

	    _get(Object.getPrototypeOf(ThreatsShowNote.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(ThreatsShowNote, [{
	    key: 'render',
	    value: function render() {
	...
	exports['default'] = ThreatsShowNote;
	module.exports = exports['default'];
